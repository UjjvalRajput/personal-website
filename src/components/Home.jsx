  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <h2 className='pt-12 text-2xl sm:text-3xl md:text-3xl font-medium text-[#ff8383]'>
          I'm a student studying Computer Science at the University of Toronto.
        </h2>
        <p className='text-[#d4d4d4] text-base sm:text-lg md:text-xl py-5 max-w-[800px] font-light'>
